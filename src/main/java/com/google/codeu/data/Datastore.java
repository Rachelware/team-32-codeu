...
public class Datastore {
    ...
    public void savePuzzles() {
        ...
        new_puzzle = new Puzzle(2, Puzzle.Puzzle_Type.TEXT, "What animal do you not want to play card with? Upload a picture of the animal for your answer. Submit the file and then submit in the answer box.", "Cheetah");
        storePuzzle(new_puzzle);
    }
